    ...
    <div>
      ...
      {showNavbar && (
          <div
            ...
            data-aos-duration="1000" onClick={switchClose}
          >
            <ul
              className={`${
            ...
            >
              <Link to="/" className="hover:text-color5 border-b-2 w-full text-center pb-2">
                Home
              </Link>
              <Link to="AboutUs" className="hover:text-color5 border-b-2 w-full text-center pb-2">
                About
              </Link>
