    ...
    <div>
      ...
      <div className="mt-10">
        ...
        <div className="flex justify-around mt-10">
          <div className="transition ease-in-out duration-1000 bg-color5 rounded-xl w-1/2 p-2 mr-3 py-4 hover:bg-[#792815]">
            <h1 className="text-color1 text-center">Request a Project</h1>
          </div>
          <div className="border-2 border-color5 rounded-xl w-1/2 p-2 py-4">
      ...
      <div className="mt-10">
        ...
        <button className="mt-10 mb-5 w-1/2 rounded-xl text-color1 text-xl py-4 bg-color5">
          Read More
        </button>
